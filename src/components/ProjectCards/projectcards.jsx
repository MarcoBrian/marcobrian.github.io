...
const project_data = [
  {
    name: 'EIT Dashboard',
    desc:
      'Dashboard for data visualization of EIT (Electrical Impedance Tomography) data, built with Dash, a python based web framework.',
    github: 'https://github.com/MarcoBrian/eit-dashboard',
  ...
  },
  {
    ...
    desc:
      'This is a telegram bot that fetches data from the John Hopkins University \
  ...
  },
  {
    ...
    desc:
      'A spyware that runs on Linux operating systems, keylogger that works inside \
  ...
  },
  {
    name: 'Mandelbrot Set',
    desc:
      "Use of Linux's system call for \
  ...
  },
  {
    ...
    desc:
      'This is a big two card game implemented in Java and decorated with a Game Of Thrones theme.',
      ...
      <Container>
        <Fade duration={1000} distance="40px">
          <div className="title-left" style={{ marginTop: '20px' }}>
            ...
            />
            <h2 className="section-title" style={{ marginBottom: '0rem' }}>
              projects
            </h2>
          </div>
        </Fade>
              ...
              return (
                <Card className="card">
                  ...
                  <Card.Body className="card-body">
                    ...
                    <Card.Text className="card-p">{project.desc}</Card.Text>
                    <ul className="link-list">
                      ...
                      {project.blog ? (
                        <li>
                          <a
                            className="link-item-icons"
                            target="_blank"
                            href={blogging_page + project.blog}
                          >
